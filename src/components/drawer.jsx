...
export const exampleProfile = {
	...
	encounterProfile: {
		...
		describeYourIdealPartner:
			"I'm looking for a man with intelligence and integrity, who values personal growth and emotional connection. Being physically active and having a sense of adventure is important, as well as enjoying the simple joys of life, including a passion for food and culture.",
		describeYourSelfInYourOwnWords:
			"I'm Julia, a 27-year-old marketing coordinator who loves the vibrant culture of Austin. I'm passionate about my career but also value balance through yoga, paddle boarding, and exploring the city's diverse culinary scene. I'm looking for meaningful connections and a partner to share in life's adventures.",
		dietaryRestrictions: ["None"],
		drinkingHabits: ["Socially"],
		email: "gfitzgerald123@gmail.com",
	...
	identities: [
		{
			...
			picture_url:
				"https://api-sandbox.argyle.com/v2/payroll-documents/018c30df-da9a-e087-5997-4f57c37cd854/file",
			platform_ids: {
				employee_id: null,
		...
		},
		{
			...
			phone_number: "+18009000010",
			picture_url:
				"https://api-sandbox.argyle.com/v2/payroll-documents/018c220f-8407-e19a-264c-39ae5dc0461f/file",
			platform_ids: {
				employee_id: null,
		...
		},
		{
			...
			phone_number: "+18009000010",
			picture_url:
				"https://api-sandbox.argyle.com/v2/payroll-documents/018c373e-3c4f-16fb-35eb-a83bacd57fcd/file",
			platform_ids: {
		...
		},
		{
			...
			phone_number: "+18009000010",
			picture_url:
				"https://api-sandbox.argyle.com/v2/payroll-documents/018c21f5-6a77-3953-b9f2-e2aa51fa8a2e/file",
			platform_ids: {
				employee_id: null,
		...
		},
		{
			...
			phone_number: "+18009000010",
			picture_url:
				"https://api-sandbox.argyle.com/v2/payroll-documents/018c21e0-1043-161d-9c4d-2c812affd7cf/file",
			platform_ids: {
				employee_id: null,
		...
		},
		{
			...
			phone_number: "+18009000010",
			picture_url:
				"https://api-sandbox.argyle.com/v2/payroll-documents/018c2117-f06a-f705-ed51-356bf11538ed/file",
			platform_ids: {
				employee_id: null,
		...
		},
		{
			...
			phone_number: "+18009000010",
			picture_url:
				"https://api-sandbox.argyle.com/v2/payroll-documents/018c20fb-d2ab-8d26-eea7-28ba41a2258b/file",
			platform_ids: {
				employee_id: null,
	...
	incomeVerification: {
		...
		userToken:
			"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..QzxPrD4E8P_xOqjSPAdhG2KsNjIu0ryR7yV2cQ3C8CQ",
	},
	incomeVerified: false,
	industry: "Technology",
	introductionDescription:
		"Christopher is a 34-year-old Software Engineer with a strong affinity for creativity and innovation. When he's not coding, he's likely to be participating in a local tech meetup, enjoying the Austin music scene, or planning his next hiking trip. He's sociable, witty, and values a genuine connection over everything.",
	isOnboarding: false,
	...
	potentialMatches: [
		{
			...
			explanation:
				"Julia and Christopher share a similar attachment style and passion for the outdoors, both enjoying hiking and live music. They value spirituality over religious attendance and both drink socially. Julia's interest in cultural experiences and intellectual conversations align with Christopher's profile. They live in the same neighborhood, which could enhance their compatibility. Furthermore, their dietary habits do not conflict, making shared meals enjoyable.",
			userId: "k107bax1qfawszasmmej7p",
		},
		{
			compatibilityScore: 89,
			explanation:
				"Emily and Christopher have both an athletic body type and a secure attachment style. They enjoy hiking and live music, value a spiritually oriented life over religious practice, and both have a social approach towards drinking. Their political views align, both preferring a liberal stance. While Emily is a vegetarian, this might not pose a significant challenge since Christopher does not have dietary restrictions.",
			userId: "RCbD8ilQuWK5kJd85LjS",
		},
		{
			compatibilityScore: 87,
			explanation:
				"Samantha and Christopher share common interests in hiking, biking, and live music. They both have a secure attachment style and lead an athletic lifestyle. The overlap in spiritual beliefs and liberal political affiliations indicates shared values. Samantha's pescatarian diet is compatible with Christopher's unrestricted approach to eating. Their goals for a committed relationship and enthusiasm for life make them a good match.",
...
export default function MenuDrawer({
	...
	const [ethnicity, setEthnicity] = React.useState(profileDetails?.ethnicity);
