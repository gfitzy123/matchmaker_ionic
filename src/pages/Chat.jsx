...
import { arrowBackOutline, copyOutline, person, personCircle, volumeMediumOutline } from 'ionicons/icons';
...
const Chat = () => {
  ...
  return (
    <>
      ...
      >
        <IonList>
          <IonItem button onClick={() => handleMenuItemClick('Option 1')}>
          <IonIcon size='large' icon={copyOutline}></IonIcon>
              <IonLabel>Copy</IonLabel>
          </IonItem>
          <IonItem button onClick={() => handleMenuItemClick('Option 1')}>
          <IonIcon size='large' icon={SelectionPlus}></IonIcon>
              <IonLabel>Select Text</IonLabel>
          </IonItem>
          <IonItem button onClick={() => handleMenuItemClick('Option 2')}>
          <IonIcon size='large' icon={volumeMediumOutline}></IonIcon>
              <IonLabel>Read Aloud</IonLabel>
          </IonItem>
          <IonItem button onClick={() => handleMenuItemClick('Option 3')}>
