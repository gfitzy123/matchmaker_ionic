    ...
    <IonPage>
      ...
      <IonContent>
        ...
        <IonRow className="flex items-center justify-center  text-sm mb-2  ">
          ...
          <IonRow>
            <IonCol>
            <IonProgressBar value={questionCount * 0.10}></IonProgressBar>
            </IonCol>
          </IonRow>
        </IonGrid>
            ...
            <IonRow key={index} className="flex items-center mb-4">
              <IonCol>
                ...
                <IonGrid className="p-4">
                  ...
                  <IonRow>
                    <IonCol>
                      <IonText className="text-sm" onClick={message.type === 'ai' ? handleLongPress : null}>
                        {message.text}
                      </IonText>
                    </IonCol>
                  </IonRow>
            ...
            <IonCol className="flex justify-center  items-center">
              ...
              <IonCol >
                {inputValue ? (
                  ...
                  <IonIcon size="small" onClick={handleVoice} className="border p-2 rounded-full bg-primaryBtn" icon={message} />
                )}
              </IonCol>
            </IonCol>
          </IonRow>
