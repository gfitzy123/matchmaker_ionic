					...
					>
						...
						>
							...
							<table style={{ color: "white" }}>
								<tbody>
									...
									<tr>
										<td>Age:</td>
										<td>
											{profileItem && profileItem.age ? profileItem.age : ""}
										</td>
									</tr>
									<tr>
										<td>Height:</td>
									...
									<tr>
										<td>Occupation:</td>
										<td>
											{profileItem && profileItem.occupation
												? profileItem.occupation
												: ""}
										</td>
									</tr>
									{profileItem && profileItem.gender === "Male" ? (
										<tr>
											...
											<td>
												...
												/>
												{getIncomeBracket(
													profileItem && profileItem.income
														? profileItem.income
														: ""
												)}
											</td>
							...
							<div>
								<p style={{ color: "white" }}>
									{" "}
									{profileItem && profileItem.introductionDescription
						...
						{showLikeButton &&
							...
							profileItem && (
								<li className="like-button">
									<button
										className="btn-Profile"
										onClick={() => handleLikeClick(profileItem, true)}
									>
						...
						{showLikeButton &&
							...
							!dateRequestSent && (
								<li className="like-button">
									<button
										className="btn-Profile"
										onClick={() => handleSetUpADate(profileItem)}
									>
						...
						{isActiveEncounter && profileItem && (
							<li className="pass-button">
								<button
									className="btn-pass"
									onClick={() => handleEndEncounter(profileItem, true)}
								>
						...
						{showPassButton &&
							...
							profileItem && (
								<li className="pass-button">
									<button
										className="btn-pass"
										onClick={() => handleLikeClick(profileItem, false)}
									>
